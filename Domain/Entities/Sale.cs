...
namespace Domain.Entities
{
    ...
    public class Sale
    {
        ...
        /// <summary>
        /// C�digo �nico de la venta (generado autom�ticamente)
        ...
        /// <summary>
        /// Nombre del cliente (denormalizado para auditor�a)
        /// </summary>
        [MaxLength(200)]
        ...
        /// <summary>
        /// Almac�n donde se realiza la venta
        /// </summary>
        [Required]
