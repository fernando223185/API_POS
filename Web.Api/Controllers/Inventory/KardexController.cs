...
namespace Web.Api.Controllers.Inventory
{
    ...
    public class KardexController : ControllerBase
    {
        ...
        /// <summary>
        /// Obtener movimientos del kardex con filtros y paginaci�n
        /// </summary>
        [HttpGet]
            ...
            [FromQuery] int pageSize = 20)
        {
            try
            {
                ...
                Console.WriteLine($"?? Consultando kardex - Producto: {productId}, Almac�n: {warehouseId}, Tipo: {movementType}");
        ...
        /// <summary>
        /// Obtener estad�sticas del kardex
        /// </summary>
        [HttpGet("statistics")]
        [RequirePermission("Inventario", "View")]
            ...
            [FromQuery] DateTime? toDate = null)
        {
            try
            {
                ...
                return Ok(new
                {
                    message = "Estad�sticas del kardex obtenidas exitosamente",
                    error = 0,
                    data = result
                });
            }
            ...
            [FromQuery] DateTime? toDate = null)
        {
            try
            {
                Console.WriteLine($"?? Exportando kardex a Excel - Producto: {productId}, Almac�n: {warehouseId}");
            ...
            [FromQuery] DateTime? toDate = null)
        {
            try
            {
                Console.WriteLine($"?? Exportando kardex a PDF - Producto: {productId}, Almac�n: {warehouseId}");
