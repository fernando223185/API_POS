...
namespace Infrastructure.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<(IEnumerable<Products> Products, int TotalCount)> GetPagedWithCountAsync(ProductPageQuery query)
        {
            ...
            // NOTA: warehouseId NO filtra productos, solo afecta qu� stock se muestra
            
            if (query.OnlyWithStock.HasValue && query.OnlyWithStock.Value)
            {
                if (query.WarehouseId.HasValue)
                {
                    // Stock en un almac�n espec�fico
                ...
                {
                    // Stock total en cualquier almac�n
                    var productIdsWithStock = await _dbcontext.ProductStock
            ...
            // Obtener conteo total antes de paginaci�n
        ...
        public async Task<(int Total, int Active, int Inactive, decimal TotalValue, int LowStock)> GetStatisticsAsync()
        {
            ...
            // ? CORREGIDO: Evitar divisi�n por cero y valores nulos
        ...
        // ? M�TODO PARA PRODUCTOS SIN STOCK
            ...
            List<ProductStock> existingStock)
        {
            ...
            {
                // No hay stock pero se especific� un almac�n, mostrar 0 para ese almac�n
            ...
            {
                // No hay stock y no se especific� almac�n, mostrar 0 para todos los almacenes activos
