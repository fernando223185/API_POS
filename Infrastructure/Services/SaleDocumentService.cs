    ...
    public class SaleDocumentService : ISaleDocumentService
    {
            ...
            container.Column(column =>
            {
                ...
                column.Item().PaddingBottom(10).Row(row =>
                {
                    row.RelativeItem().Column(col =>
                    {
                        ...
                        col.Item().Text($"Almac�n: {sale.Warehouse?.Name ?? "N/A"}");
                    });
                ...
                if (sale.Payments.Any())
                {
                    column.Item().PaddingTop(15).Column(col =>
                    {
                        ...
                        foreach (var payment in sale.Payments)
                        {
                            ...
                            {
                                col.Item().Text($"  Autorizaci�n: {payment.AuthorizationCode}").FontSize(8).FontColor(Colors.Grey.Darken1);
                            }
                        }
        ...
        private void ComposeFooter(IContainer container)
        {
            container.Column(column =>
            {
                ...
                column.Item().AlignCenter().Text("Conserve este ticket para cualquier aclaraci�n")
            ...
            container.Column(column =>
            {
                column.Item().Row(row =>
                {
                    row.RelativeItem().Column(col =>
                    {
                        ...
                        col.Item().Text("R�gimen Fiscal: 601 - General").FontSize(9);
                    });
        ...
        {
            // Similar a ComposeContent pero con m�s detalles fiscales
