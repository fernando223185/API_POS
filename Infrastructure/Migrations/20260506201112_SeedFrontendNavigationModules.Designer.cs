...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260506201112_SeedFrontendNavigationModules")]
    partial class SeedFrontendNavigationModules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.QuotationDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ShippingCarrier", b =>
                {
                    ...
                    b.Property<string>("AccountRepEmail")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("AccountRepName")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("AccountRepPhone")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<decimal?>("ExpressPricePerKg")
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("Domain.Entities.StockAdjustmentDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.WarehouseTransferDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.WarehouseTransferReceiving", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WarehouseTransferReceivings");
                });

            modelBuilder.Entity("Domain.Entities.WarehouseTransferReceivingDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WarehouseTransferDetailId")
                        .HasColumnType("int");

                    b.Property<int>("WarehouseTransferReceivingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WarehouseTransferDetailId");

                    b.HasIndex("WarehouseTransferReceivingId");
            ...
            modelBuilder.Entity("Domain.Entities.WarehouseTransfer", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "DispatchedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.WarehouseTransferReceivingDetail", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.WarehouseTransferDetail", "WarehouseTransferDetail")
                        .WithMany("ReceivingDetails")
                        .HasForeignKey("WarehouseTransferDetailId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.WarehouseTransferReceiving", "WarehouseTransferReceiving")
                        .WithMany("Details")
                        .HasForeignKey("WarehouseTransferReceivingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("WarehouseTransferReceiving");
                });
